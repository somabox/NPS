...
stresslevel = 0
Currentstates = {
	[1] = { ["text"] = "Mãos vermelhas", ["status"] = false, ["timer"] = 0 },
	[2] = { ["text"] = "Olhos dilatados", ["status"] = false, ["timer"] = 0 },
	[3] = { ["text"] = "Olhos vermelhos", ["status"] = false, ["timer"] = 0 },
	[4] = { ["text"] = "Cheira como maconha", ["status"] = false, ["timer"] = 0 },
	[5] = { ["text"] = "Bandagem fresca", ["status"] = false, ["timer"] = 0 },
	[6] = { ["text"] = "Agitadx", ["status"] = false, ["timer"] = 0 },
	[7] = { ["text"] = "Descoordenadx", ["status"] = false, ["timer"] = 0 },
	[8] = { ["text"] = "Respiração cheira como álcool", ["status"] = false, ["timer"] = 0 },
	[9] = { ["text"] = "Cheira a gasolina", ["status"] = false, ["timer"] = 0 },
	[10] = { ["text"] = "Resíduo de pólvora vermelha", ["status"] = false, ["timer"] = 0 },
	[11] = { ["text"] = "Cheiros de produtos químicos", ["status"] = false, ["timer"] = 0 },
	[12] = { ["text"] = "Cheiros de óleo / metal", ["status"] = false, ["timer"] = 0 },
	[13] = { ["text"] = "Mão manchada de tinta", ["status"] = false, ["timer"] = 0 },
	[14] = { ["text"] = "Cheira como fumaça.", ["status"] = false, ["timer"] = 0 },
	[15] = { ["text"] = "Tem equipamento de acampamento.", ["status"] = false, ["timer"] = 0 },
	[16] = { ["text"] = "Cheira como alumínio queimado e ferro.", ["status"] = false, ["timer"] = 0 },
	[17] = { ["text"] = "Tem manchas de metal na roupa.", ["status"] = false, ["timer"] = 0 },
	[18] = { ["text"] = "Cheira como fumaça de cigarro.", ["status"] = false, ["timer"] = 0 },
	[19] = { ["text"] = "Respiração ofegante", ["status"] = false, ["timer"] = 0 },
	[20] = { ["text"] = "Suor no corpo.", ["status"] = false, ["timer"] = 0 },
	[21] = { ["text"] = "Suor na roupa.", ["status"] = false, ["timer"] = 0 },	
    [22] = { ["text"] = "Cortes de arame", ["status"] = false, ["timer"] = 0 },
	[23] = { ["text"] = "Roupas saturadas.", ["status"] = false, ["timer"] = 0 },		
    [24] = { ["text"] = "Parece confuso ", ["status"] = false, ["timer"] = 0 },
    [25] = { ["text"] = "Parece bem alimentado.", ["status"] = false, ["timer"] = 0 },
    [26] = { ["text"] = "Tem arranhões nas mãos.", ["status"] = false, ["timer"] = 0 }, 
    [27] = { ["text"] = "Parece alerta.", ["status"] = false, ["timer"] = 0 }, 
}
...
function updateStates()
    ...
    if GetPedArmour(PlayerPedId()) > 1 and armor then
	    table.insert( CurrentDamageList, "Está usando colete." )
	elseif armor then
		armor = false
	end
end
...
function myBleeds()
    ...
    if not initialbleed and math.random(100) < 20 then
        if lightbleed or heavybleed or lightestbleed then
            TriggerEvent("DoLongHudText","Você sente o sangue escorrendo do seu corpo, mais você se move.",2)
            SetEntityHealth(PlayerPedId(), GetEntityHealth(PlayerPedId()) - bleedmulti)
        end
    end

    if initialbleed then
        TriggerEvent("DoLongHudText","Você sente o sangue escorrendo do seu corpo, mais você consegue andar.",2)
        for i = 1, 7 do
             if lightbleed or heavybleed or lightestbleed then
                SetEntityHealth(PlayerPedId(), GetEntityHealth(PlayerPedId()) - bleedmulti)
                Citizen.Wait(350)
