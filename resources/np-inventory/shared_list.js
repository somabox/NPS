...
itemList["1gcocaine"]	= {fullyDegrades: true, illegal: true, decayrate: 0.5, displayname: "Cocaína (5g)",    craft: [ {itemid: "glucose", amount: 0.01 }, {itemid: "coke5g", amount: 0.1 } ], price: 100, weight: 0,   nonStack: false, model: "", image: "np_cocaine.png", information: "É um fármaco alcalóide de tropane e estimulante obtido das folhas de coca, coca eritroxilum e eritroxilo Novogranatense. Aumenta sua Stamina e velocidade de movimento ", deg: false}
itemList["1gcrack"]	    = {fullyDegrades: true, illegal: true, decayrate: 0.5, displayname: "Crack (5g)",  craft: [ {itemid: "bakingsoda", amount: 0.01 } , {itemid: "coke5g", amount: 0.1 } ], price: 100, weight: 0,   nonStack: false, model: "", image: "np_crack.png", information: "Crack do resto da cocaína, também conhecido simplesmente como crack ou pedra, é uma forma base livre de cocaína que pode ser fumado. Crack oferece um curto e intenso efeito. ", deg: false}


itemList["coke50g"]	    = {fullyDegrades: true, illegal: true, decayrate: 0.5, displayname: "Cocaína (50g)", price: 1000, weight: 5, nonStack: false, model: "", image: "np_cocaine-brick.png", information: "Bloco de um fármaco alcalóide de tropane e estimulante obtido das folhas de coca, coca eritroxilum e eritroxilo Novogranatense. <br> <b> Aumenta sua Stamina e velocidade de movimento </b> " , deg: false}
itemList["coke5g"]	    = {fullyDegrades: true, illegal: true, decayrate: 0.5, displayname: "Cocaína (15g)", craft: [{itemid: "coke50g", amount: 0.1 }], price: 150, weight: 0, nonStack: false, model: "", image: "np_cocaine-baggs.png", information: "Pacote de um fármaco alcalóide de tropane e estimulante obtido das folhas de coca, coca eritroxilum e eritroxilo Novogranatense. Aumenta sua Stamina e velocidade de movimento " , deg: false}


itemList["joint"]	    = {fullyDegrades: true, illegal: true, decayrate: 0.75, displayname: "Baseado",    craft: [ {itemid: "weedq", amount: 0.5 }, {itemid: "rollingpaper", amount: 1 } ], price: 20, weight: 0,   nonStack: false, model: "", image: "np_joint.png", information: "Um baseado, também conhecido no Brasil como beque ou fino ou, ainda, banza, e ganja. É um cigarro de maconha (Cannabis) já bolado", deg: false}

itemList["maleseed"]	= {fullyDegrades: true, decayrate: 2.0, displayname: "Semente Macho", price: 100, weight: 0,   nonStack: false, model: "", image: "np_weed-seed.png", information: "Estas cepas não são alteradas ou geneticamente modificadas, e são oferecidas por muitos criadores de semente de maconha. Plante perto das fêmeas para fazê-las produzir sementes. ", deg: false}
itemList["femaleseed"]	= {fullyDegrades: true, decayrate: 2.0, displayname: "Semente Feminizada", price: 100, weight: 0,   nonStack: false, model: "", image: "np_weed-seed.png", information: "Essas cepas populares são desenvolvidas para florescer apenas como plantas femininas e, por isso, é esperado que as sementes de cannabis feminizadas sejam 99,99% femininas. <br> <b> Plante perto dos machos para fazê-las produzir sementes.</b>" , deg: false}


itemList["methbag"]	    = {fullyDegrades: true, illegal: true, decayrate: 2.0, displayname: "Meta (1g)", price: 500, weight: 0, nonStack: false, model: "", image: "np_meth-baggy.png", information: "-7 Prisão <br> +5 Fedor <br> Aumenta sua velocidade, resistência e movimento - cheira podre, mas é o que tem pra hoje." , deg: false}

itemList["oxy"]	        = {fullyDegrades: true, illegal: true, decayrate: 0.75, displayname: "Oxy 100mg", price: 150, weight: 0, nonStack: false, model: "", image: "np_Oxy.png", information: "Oxy é uma mistura da pasta base de cocaína, com substâncias químicas de fácil acesso, como querosene, gasolina, cal virgem ou solvente. <br> <b> Limita o estresse para 0 por um longo período de tempo. Aumenta a sede e é víciante " , deg: false}


itemList["weed12oz"]	= {fullyDegrades: true, illegal: true, decayrate: 0.0025, displayname: "Maconha (7 kg)", price: 250, weight: 35, nonStack: false, model: "", image: "np_box-of-weed-12-18-oz.png", information: "Uma caixa de 7 kilos contendo maconha. Reduz o estresse. <br> <b> Abra para pegar as ervas.</b>" , deg: false}
itemList["weed5oz"]	    = {fullyDegrades: true, illegal: true, decayrate: 0.5, displayname: "Maconha (250g)", price: 500,   weight: 5, nonStack: false, model:  "", image: "np_weed-brick-40-Oz.png", information: "Um bloco de 250 gramas contendo maconha. Reduz o estresse. <br> <b> Abra para pegar as ervas. </b>" , deg: false}
itemList["weedoz"]	    = {fullyDegrades: true, illegal: true, decayrate: 0.3, displayname: "Weed Oz", price: 200, weight: 4, nonStack: false, model:  "", image: "np_weed-4-Oz.png", information: "Um pacote contendo maconha. Reduz o estresse. <br> <b> Abra para craftar ervas." , deg: false}
...
itemList["rollingpaper"]	= {fullyDegrades: false, decayrate: 0.0, displayname: "Seda", price: 1, weight: 0, nonStack: false, model: "", image: "np_rolling-paper.png", information: "Usado para enrolar algum tipo de fumo." , deg: false}
